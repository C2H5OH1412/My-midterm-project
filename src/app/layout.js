  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <div className="w-screen h-screen overflow-auto flex flex-col sm:flex-row gap-5 bg-gray-200 p-8">

          <div className="w-[480px] h-full rounded-2xl bg-white flex  justify-start items-center flex-col p-[30px] pt-[80px] overflow-y-auto overflow-x-hidden">
